...
import static org.jinjuamla.excellon.ExcellonDecoderState.PARSER_STATE_INIT;

/**
 *
 * @author psammand
 */
public class ECmdRewindStop extends ECmd {

    public ECmdRewindStop() {
    }
    ...
    public Geometry[] evaluate( ExcellonDecoderState state ) {
        ...
        else if ( state.getState() == PARSER_STATE_INIT ) {
            state.setState( PARSER_STATE_HEADER );
        }
